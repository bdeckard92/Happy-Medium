$(document).ready(function () {
    ...
    //var votes = {}; //init empty votes tally object
    ...
    // ...
        ...
        $("#voteButton").click(function() {
            if ($("input[name='locationOption']").is(":checked")) {
                var val = $("input:radio[name=locationOption]:checked").val(); console.log("value: " + val);
                            
                //push to db
                //database.ref("votes/" + val).set();
                //change text of vote button to voted, disable
                $("#voteButton").attr('disabled', true); //enable vote button
                voted = true; //set flag for voted 
            } else {
